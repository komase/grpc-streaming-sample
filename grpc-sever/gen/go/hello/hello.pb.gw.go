...
var (
	filter_Messenger_SayHello_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Messenger_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client MessengerClient, req *http.Request, pathParams map[string]string) (Messenger_SayHelloClient, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Messenger_SayHello_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterMessengerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MessengerServer) error {
	...
	mux.Handle("GET", pattern_Messenger_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterMessengerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MessengerClient) error {
	...
	mux.Handle("GET", pattern_Messenger_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.Messenger/SayHello", runtime.WithHTTPPathPattern("/v1/hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Messenger_SayHello_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_Messenger_SayHello_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Messenger_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "hello"}, ""))
)

var (
	forward_Messenger_SayHello_0 = runtime.ForwardResponseStream
)
